        ...
        <div class="w-full navbar bg-base-300">
          ...
          <div class="flex-none hidden lg:block">
            <ul class="menu menu-horizontal space-x-2">
              ...
              <li>
                <router-link class="font-semibold focus:bg-primary focus:text-white/80"
                             :class="$route.name === 'dashboard' ? 'btn-primary' : ''"
                             :to="$router.resolve({ name: 'dashboard' }).href"><i class="text-lg ti ti-home" /> <span>Dashboard</span></router-link>
              </li>
              <li>
                <router-link class="font-semibold focus:bg-primary focus:text-white/80"
                             :class="$route.name === 'products' ? 'btn-primary' : ''"
                             :to="$router.resolve({ name: 'products' }).href"><i class="text-lg ti ti-color-swatch" /> <span>Products</span></router-link>
              </li>
              <li>
                <router-link class="font-semibold focus:bg-primary focus:text-white/80"
                             :class="$route.name === 'categories' ? 'btn-primary' : ''"
                             :to="$router.resolve({ name: 'categories' }).href"><i class="text-lg ti ti-tag" /> <span>Categories</span></router-link>
              </li>
              <li>
                <details>
